...
const Popular = () => {
    ...
    const fetchPopularNews = async () => {
        try {
            const request = await fetch('https://newsapi.org/v2/everything?q=apple&from=2023-12-04&to=2023-12-04&sortBy=popularity&apiKey=b44c99bcd32b45d4a5db0a131fac977b')
